...
* Create a branch in your project named `mt04-setup`
* Create a directory named `tutorials`
* Add a file named `tutorials/rust-setup-tutorial.md` or `tutorials/go-setup-tutorial.md`, whichever you are going to be working on, with the following contents:
   ```markdown
